...
export const handler = async (event) => {
  ...
  try {
    ...
    const { userWithAccess, categories, ...rest } = body;
    ...
    const categoriesIds = categories ? `cat#${categories.map(cat => cat.categoryId).join("#")}` : "";
    ...
    expressionAttributeNames["#categoriesIds"] = "categoriesIds";
    expressionAttributeValues[":categoriesIds"] = categoriesIds;
    updateExpressionParts.push("#categoriesIds = :categoriesIds");
